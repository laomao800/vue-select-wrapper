/*! @laomao800/vue-select-wrapper v1.1.1 */
module.exports =
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"78575d8c-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/SelectWrapper.vue?vue&type=template&id=57435b99&
var render = function () {
var _obj;
...
// CONCATENATED MODULE: ./src/SelectWrapper.vue?vue&type=template&id=57435b99&
...
/* harmony default export */ var SelectWrappervue_type_script_lang_js_ = ({
  ...
  watch: {
    ...
    value: function value(val) {
      ...
      this.$nextTick().then(function () {
        ...
        if (_this.internalCloseOnSelect) {
          _this.hideDropdown();
        }
      });
    }
  ...
  mounted: function mounted() {
    ...
    if (this.appendToBody) {
      ...
      this.$nextTick().then(function () {
        ...
        loopGetScrollParent(getScrollParents(_this2.$refs.trigger));

        _this2.scrollParents.forEach(function (element) {
          element.addEventListener('scroll', _this2.updatePopper);
        });

        window.addEventListener('resize', _this2.updatePopper);
      });
    }
  },
  beforeDestroy: function beforeDestroy() {
    ...
    this.scrollParents.forEach(function (element) {
      element.removeEventListener('scroll', _this3.updatePopper);
    });
  ...
  methods: {
    delValue: function delValue(index) {
      if (Array.isArray(this.value)) {
        var newValue = [].concat(this.value.slice(0, index), this.value.slice(index + 1, this.value.length));
