/*! @laomao800/vue-select-wrapper v1.1.0 */
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-select-wrapper"] = factory();
	else
		root["vue-select-wrapper"] = factory();
...
// load the styles
var content = __webpack_require__("4282");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("1e082da6", content, true, {"sourceMap":false,"shadowMode":false});
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"7a7dd598-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/SelectWrapper.vue?vue&type=template&id=ab9a7798&
var render = function () {
var _obj;
var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{directives:[{name:"click-outside",rawName:"v-click-outside",value:(_vm.hideDropdown),expression:"hideDropdown"}],class:( _obj = {
  ...
  }, _obj[("sw__wrapper--" + _vm.size)] = _vm.size, _obj )},[_c('div',{ref:"trigger",staticClass:"sw__trigger",on:{"click":_vm.toggleDropdown}},[_c('div',{ref:"trigger",staticClass:"sw__selection"},[(_vm.isEmptyValue)?_c('div',{staticClass:"sw__placeholder"},[_vm._v(_vm._s(_vm.placeholder))]):[(_vm.multiple)?_c('div',{staticClass:"sw__multiple"},[_vm._l((_vm.showingValue),function(row,index){return _c('div',{key:index,staticClass:"sw__tag"},[_c('span',{staticClass:"sw__tag-text"},[_vm._t("value-template",[_vm._v(_vm._s(row))],{"value":row})],2),(!_vm.disabled)?_c('span',{staticClass:"sw__tag-del",on:{"click":function($event){$event.stopPropagation();return _vm.delValue(index)}}},[_c('i',{staticClass:"sw__icon-close"})]):_vm._e()])}),(_vm.limit && _vm.value.length > _vm.limit)?_c('div',{staticClass:"sw__tag sw__tag-limit"},[_vm._v("\n            "+_vm._s(_vm.limitText(_vm.value.length - _vm.limit))+"\n          ")]):_vm._e()],2):_c('div',{staticClass:"sw__single"},[_c('div',{staticClass:"sw__tag-text"},[_vm._t("value-template",[_vm._v(_vm._s(_vm.value))],{"value":_vm.value})],2)])]],2),(!_vm.disabled)?_c('div',{staticClass:"sw__suffix"},[_c('i',{staticClass:"sw__icon-arrow-down"}),(_vm.clearable && !_vm.isEmptyValue)?_c('span',{staticClass:"sw__clear",on:{"click":function($event){$event.stopPropagation();return _vm.clearValue($event)}}},[_c('i',{staticClass:"sw__icon-close"})]):_vm._e()]):_vm._e()]),_c('transition',{attrs:{"name":"sw__dropdown-trans"}},[_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.visible),expression:"visible"}],ref:"popupContainer",class:['sw__dropdown', _vm.popperClass],style:(_vm.popupComputedStyle),on:{"click":function($event){$event.stopPropagation();}}},[(_vm.loading)?_c('div',{staticClass:"sw__loading"},[_vm._v(_vm._s(_vm.loadingText))]):_vm._e(),_c('div',{directives:[{name:"show",rawName:"v-show",value:(!_vm.loading),expression:"!loading"}]},[_vm._t("default")],2)])])],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/SelectWrapper.vue?vue&type=template&id=ab9a7798&
...
// EXTERNAL MODULE: ./node_modules/@laomao800/parse-size-with-unit/index.js
var parse_size_with_unit = __webpack_require__("7b06");
var parse_size_with_unit_default = /*#__PURE__*/__webpack_require__.n(parse_size_with_unit);
...
// CONCATENATED MODULE: ./src/clickOutSide.js
...
// CONCATENATED MODULE: ./src/getScrollParents.js
var root = window;
...
var style = __webpack_require__("cd4d");

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/SelectWrapper.vue?vue&type=script&lang=js&
...
var SelectWrappervue_type_script_lang_js_isEmpty = function isEmpty(val) {
  return !has_values_default()(val);
};

/* harmony default export */ var SelectWrappervue_type_script_lang_js_ = ({
  name: 'SelectWrapper',
  inheritAttrs: false,
  directives: {
  ...
  computed: {
    isEmptyValue: function isEmptyValue() {
      return SelectWrappervue_type_script_lang_js_isEmpty(this.value);
    },
    popupComputedStyle: function popupComputedStyle() {
      return _objectSpread({
        width: parse_size_with_unit_default()(this.dropdownWidth),
    ...
    internalCloseOnSelect: function internalCloseOnSelect() {
      return this.closeOnSelect !== undefined ? this.closeOnSelect : !this.multiple;
    }
  },
  watch: {
    visible: {
  ...
  created: function created() {
    if (this.multiple && !Array.isArray(this.value)) {
      // eslint-disable-next-line no-console
      console.error('[SelectWrapper error] Expected array with v-model/value in multiple mode, got ' + typeof_typeof(this.value) + ' with value ' + this.value.toString());
    }
  },
    ...
    if (this.appendToBody) {
      ...
      this.$nextTick().then(function () {
        ...
        var loopGetScrollParent = function loopGetScrollParent(parentEle) {
          ...
          _this.scrollParents.push(parent);
        };

        loopGetScrollParent(getScrollParents(_this.$refs.trigger));

        _this.scrollParents.forEach(function (element) {
          element.addEventListener('scroll', _this.updatePopper);
        });

        window.addEventListener('resize', _this.updatePopper);
      });
    }
  },
  beforeDestroy: function beforeDestroy() {
    ...
    this.scrollParents.forEach(function (element) {
      element.removeEventListener('scroll', _this2.updatePopper);
    });
  ...
  methods: {
    delValue: function delValue(index) {
      if (Array.isArray(this.value)) {
        var newValue = [].concat(_toConsumableArray(this.value.slice(0, index)), _toConsumableArray(this.value.slice(index + 1, this.value.length)));
    ...
    getPopupStyle: function getPopupStyle() {
      ...
      return {
        ...
        width: this.dropdownWidth ? "".concat(this.dropdownWidth, "px") : "".concat(triggerBounding.width, "px")
      };
    },
...
// CONCATENATED MODULE: ./src/SelectWrapper.vue?vue&type=script&lang=js&
 /* harmony default export */ var src_SelectWrappervue_type_script_lang_js_ = (SelectWrappervue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./src/SelectWrapper.vue
...
var component = normalizeComponent(
  src_SelectWrappervue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var SelectWrapper = (component.exports);
...
/* harmony default export */ var src = (SelectWrapper);
